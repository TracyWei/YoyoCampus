...
App.page('homepage',function(){
    this.init = function(){
        var slider;
        $('#homepage_section article').on('articleshow',function(){
            slider = new J.Slider({
...
App.page('getshop-info',function(){
    this.init = function(){
        alert("aaa");

    $('#shoptype').click(function(event) {
    $('.type-of-shop').show();
    $('.choose-type').show();
    });
    $('#shoptype-cancel').click(function(event) {
    $('.type-of-shop').hide();
    $('.choose-type').hide();
    });
    $('.type-of-shop').click(function(event) {
    $('.type-of-shop').hide();
    $('.choose-type').hide();
    });
    $('#apply-seller').click(function(event) {
    $('#apply-span').addClass('click-grey');
    $('.notice').show();
    $('#apply-seller').unbind('click');
    console.log("aa");
    });
    }
})
App.page('bianjifenlei',function(){
    this.init = function(){
        new Bianjifenlei();
    }
})
App.page('signup',function(){
    this.init = function(){
        new Signup();
    }
})
App.page('findpw',function(){
    this.init = function(){
        new Findpw();
    }
})
App.page('xianzhi',function(){
    this.init = function(){
        new Xianzhi();
    }
})
App.page('choose-campus',function(){
    this.init = function(){
        new ChooseCampus();
}
})
App.page('travel',function(){
    this.init=function(){
        console.log("ayaya");
        new Travel();
    }
})
App.page('clothes',function(){
    this.init=function(){
        new Clothes();
    }
})
App.page('driver',function(){
    this.init=function(){
        new Driver();
    }
})
App.page('study',function(){
    this.init=function(){
        new Study();
    }
})
App.page('personalShop',function(){
    this.init=function(){
        new PersonalShop();
    }
})
